...
const Investors = [{
    ...
    name: "Walter White",
    positionAndCompany: <>Co-Founder of <br />Gray Matter Technologies</>
}, {
    image: "/Investors/MarkZuckerberg.jpg",
    name: "Mark Zuckerberg",
    positionAndCompany: "CEO of Facebook"
}, {
    image: "/Investors/BernardArnault.jpg",
    name: "Bernard Arnault",
    positionAndCompany: <>CEO of Moët Hennessy<br />Louis Vuitton</>
}]
            ...
            <main style={{ minHeight: "100vh" }}>
                ...
                <div className="w-10 mx-auto">
                    ...
                    <div className="my-8 text-center">
                        ...
                        <div className="mb-2">Say hello to the team that brought you {ORG_NAME}</div>
                        <div>
                            ...
                            <div className="text-xs">
                                Photo from <a className="text-primary-500" target="_blank" href="https://www.interiorhealth.ca/media/interior-health-paving-way-medical-leadership-training">InteriorHealth</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="w-10 mx-auto mb-8">
                    ...
                    <div className="grid">
                        {Investors.map((investor) => <InvestorTemplate key={investor.name.replace(/ /g, "")} investor={investor} />)}
                    </div>
...
const InvestorTemplate = ({ investor, noRound = false }) => <div className='col-3 border-round-top-sm'>
    <div className='flex flex-column align-items-center'>
        ...
        }} width='96px' height='96px' src={investor.image} /></div>
